...
// New Vars created to toggle these options. Replaces B_EXP_CAP_TYPE and B_SHOW_EFFECTIVENESS
#define VAR_EXP_CAP_TYPE VAR_UNUSED_0x4083
#define VAR_SHOW_EFFECTIVENESS VAR_UNUSED_0x408B
