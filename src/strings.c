...
const u8 gText_ExpShareOn[] = _("Lvl. Cap has been turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareOff[] = _("Lvl. Cap has been turned off.{PAUSE_UNTIL_PRESS}");
const u8 gText_TypeEffectivenessOn[] = _("Type effectiveness has been turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_TypeEffectivenessOff[] = _("Type effectiveness has been turned off.{PAUSE_UNTIL_PRESS}");
